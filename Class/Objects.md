...
예로 커피자판기를 생각해 보자. 커피 자판기는 일반적인 속성으로 *커피, 프림, 설탕, 물* 을 가진다. 실제 커피 자판기를 설치하고 동 시키기 위해서 실제 커피, 설탕, 프림, 물이 자판기 내부의 재료 통 안에 들어 있어야 하는데 이 때 통 안 있는 커피, 설탕, 프림, 물의 제품(브랜드)는 커피 자판기 운영자에 따라 다를 것이다. 이러한 제품명이 속성 값의 예가 될 수 있다. 
